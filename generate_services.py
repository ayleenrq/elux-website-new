...
data = {
    '#services-seed-mvp': {
        ...
        'deliverables': [
            {'title': 'Core User Flows', 'span': 2, 'description': 'Mapping the exact path to value for your users, removing all unnecessary friction.'},
            {'title': 'High-Fidelity UI', 'span': 1, 'description': 'Premium visual design for 10-15 core screens.'},
            {'title': 'Design System Lite', 'span': 1, 'description': 'A foundational set of components to speed up development.'},
            {'title': 'Developer Handoff', 'span': 2, 'description': 'Figma files annotated with exact specs, assets, and variables. Ready to be coded.', 'imagePlaceholder': True}
        ],
        'processSteps': [
    ...
    '#services-seed-prototype': {
        ...
        'deliverables': [
            {'title': 'Interactive Figma Prototype', 'span': 2, 'description': 'A fully linked, clickable demonstration of your core user journey.'},
            {'title': 'Micro-interactions', 'span': 1, 'description': 'Hover states, transitions, and loading animations that sell the realism.'},
            {'title': 'Pitch Presentation', 'span': 1, 'description': 'Screenshots and recordings optimized for your pitch deck.'},
            {'title': 'User Testing Setup', 'span': 2, 'description': 'Prototype configured specifically for Maze or UserTesting.com to gather early feedback.', 'imagePlaceholder': True}
        ],
        'processSteps': [
        ...
        'featuredProofImage': 'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&w=2070&auto=format&fit=crop'
    },
    '#services-seed-landing': {
        ...
        'deliverables': [
            {'title': 'Strategic Copywriting', 'span': 2, 'description': 'We help refine your value proposition and write persuasive, benefit-driven copy.'},
            {'title': 'Custom Illustrations/3D', 'span': 1, 'description': 'Unique visual assets that differentiate your brand from templates.'},
            {'title': 'Responsive Design', 'span': 1, 'description': 'Flawless experience across mobile, tablet, and desktop.'},
            {'title': 'Webflow Development', 'span': 2, 'description': 'Optional: We can build and host the page on Webflow, integrating with your CRM.', 'imagePlaceholder': True}
        ],
        'processSteps': [
    ...
    '#services-seed-nocode': {
        ...
        'deliverables': [
            {'title': 'Database Architecture', 'span': 2, 'description': 'Structuring your data models for scalability and performance within the no-code platform.'},
            {'title': 'Custom UI Design', 'span': 1, 'description': 'Bespoke interfaces designed in Figma before being built.'},
            {'title': 'API Integrations', 'span': 1, 'description': 'Connecting your app to Stripe, SendGrid, OpenAI, and more.'},
            {'title': 'Fully Functional App', 'span': 2, 'description': 'A live, usable application ready for your first paying customers.', 'imagePlaceholder': True}
        ],
        'processSteps': [
    ...
    '#services-seed-pitch': {
        ...
        'deliverables': [
            {'title': 'Narrative Structuring', 'span': 2, 'description': 'Organizing your deck to flow logically from problem to solution to traction.'},
            {'title': 'Deck Design', 'span': 1, 'description': '15-20 beautifully designed slides in Figma or Pitch.com.'},
            {'title': 'Product Mockups', 'span': 1, 'description': 'Hero shots of your interface to make the solution real.'},
            {'title': 'Data Visualization', 'span': 2, 'description': 'Turning boring charts into compelling infographics that highlight your growth.', 'imagePlaceholder': True}
        ],
        'processSteps': [
    ...
    '#services-growth-audit': {
        ...
        'deliverables': [
            {'title': 'Heuristic Evaluation', 'span': 2, 'description': 'A comprehensive review of your app against usability best practices.'},
            {'title': 'Friction Mapping', 'span': 1, 'description': 'Visualizing exactly where users are abandoning the funnel.'},
            {'title': 'Quick Wins', 'span': 1, 'description': 'Immediate, low-effort changes that can boost metrics today.'},
            {'title': 'Prioritized Roadmap', 'span': 2, 'description': 'A strategic plan for the next 3-6 months of product design work.', 'imagePlaceholder': True}
        ],
        'processSteps': [
    ...
    '#services-growth-brand': {
        ...
        'deliverables': [
            {'title': 'UI Refresh', 'span': 2, 'description': 'Updating core screens with a modern visual language.'},
            {'title': 'Updated Design Tokens', 'span': 1, 'description': 'New color palettes, typography scales, and spacing rules.'},
            {'title': 'Iconography & Assets', 'span': 1, 'description': 'A cohesive set of icons and illustrations.'},
            {'title': 'Implementation Guide', 'span': 2, 'description': 'CSS/Tailwind variables and guidance for developers to apply the new styles.', 'imagePlaceholder': True}
        ],
        'processSteps': [
    ...
    '#services-growth-redesign': {
        ...
        'deliverables': [
            {'title': 'New Information Architecture', 'span': 2, 'description': 'Restructuring the navigation and hierarchy of the application.'},
            {'title': 'Optimized User Flows', 'span': 1, 'description': 'Streamlining the paths for core tasks.'},
            {'title': 'Comprehensive UI Redesign', 'span': 1, 'description': 'A completely new, modern interface.'},
            {'title': 'Phased Rollout Strategy', 'span': 2, 'description': 'A plan to release the redesign in stages to avoid shocking users.', 'imagePlaceholder': True}
        ],
        'processSteps': [
    ...
    '#services-growth-dashboard': {
        ...
        'deliverables': [
            {'title': 'Dashboard Architecture', 'span': 2, 'description': 'Structuring the page to prioritize the most important metrics.'},
            {'title': 'Data Visualization Design', 'span': 1, 'description': 'Selecting the right charts for the right data.'},
            {'title': 'Advanced Table UX', 'span': 1, 'description': 'Designing sorting, filtering, and bulk actions.'},
            {'title': 'Responsive Layouts', 'span': 2, 'description': 'Ensuring complex data remains usable on smaller screens.', 'imagePlaceholder': True}
        ],
        'processSteps': [
    ...
    '#services-growth-team': {
        ...
        'deliverables': [
            {'title': 'Dedicated Senior Designers', 'span': 2, 'description': 'Experts who focus entirely on your product.'},
            {'title': 'Agile Integration', 'span': 1, 'description': 'Participation in standups, sprint planning, and retros.'},
            {'title': 'Continuous Delivery', 'span': 1, 'description': 'A steady stream of shippable design work.'},
            {'title': 'Design Ops Support', 'span': 2, 'description': 'We bring our own tools, templates, and efficiencies to improve your internal processes.', 'imagePlaceholder': True}
        ],
        'processSteps': [
    ...
    '#services-scale-designsystem': {
        ...
        'deliverables': [
            {'title': 'Design Tokens', 'span': 2, 'description': 'A systematic approach to color, typography, spacing, and elevation.'},
            {'title': 'Component Library', 'span': 1, 'description': 'Figma library with variants, auto-layout, and interactive states.'},
            {'title': 'Usage Guidelines', 'span': 1, 'description': 'Documentation on when and how to use specific components.'},
            {'title': 'Governance Model', 'span': 2, 'description': 'A clear process for how the team updates and maintains the system over time.', 'imagePlaceholder': True}
        ],
        'processSteps': [
    ...
    '#services-scale-enterprise': {
        ...
        'deliverables': [
            {'title': 'Role-Based Workflows', 'span': 2, 'description': 'Optimizing the interface for specific permissions and user goals.'},
            {'title': 'Scalable Architecture', 'span': 1, 'description': 'Navigation structures that can handle hundreds of features.'},
            {'title': 'Legacy Migration Strategy', 'span': 1, 'description': 'Planning the transition from the old system to the new.'},
            {'title': 'High-Fidelity UI', 'span': 2, 'description': 'A modern, accessible interface that meets enterprise standards.', 'imagePlaceholder': True}
        ],
        'processSteps': [
        ...
        'featuredProofImage': 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=2070&auto=format&fit=crop'
    },
    '#services-scale-website': {
        ...
        'deliverables': [
            {'title': 'Strategic Narrative', 'span': 2, 'description': 'Structuring the site map to guide visitors through your story.'},
            {'title': 'Bespoke UI Design', 'span': 1, 'description': 'Unique layouts that reflect your brand identity.'},
            {'title': 'Interaction Design', 'span': 1, 'description': 'Custom WebGL or CSS animations for premium feel.'},
            {'title': 'CMS Architecture', 'span': 2, 'description': 'Designing a scalable backend for your marketing team to manage content.', 'imagePlaceholder': True}
        ],
        'processSteps': [
    ...
    '#services-scale-ongoing': {
        ...
        'deliverables': [
            {'title': 'Strategic Planning', 'span': 2, 'description': 'Monthly roadmap planning to align design efforts with business goals.'},
            {'title': 'Continuous UI/UX', 'span': 1, 'description': 'Ongoing design execution for new features and improvements.'},
            {'title': 'Design Leadership', 'span': 1, 'description': 'Mentorship and direction for your junior internal designers.'},
            {'title': 'Predictable Velocity', 'span': 2, 'description': 'A guaranteed amount of senior design output every single month.', 'imagePlaceholder': True}
        ],
        'processSteps': [
    ...
    '#services-scale-research': {
        ...
        'deliverables': [
            {'title': 'Generative Research', 'span': 2, 'description': 'In-depth interviews to uncover unmet needs and new market opportunities.'},
            {'title': 'Journey Mapping', 'span': 1, 'description': 'Visualizing the complete end-to-end customer experience.'},
            {'title': 'Usability Testing', 'span': 1, 'description': 'Rigorous testing of prototypes before committing to code.'},
            {'title': 'Strategic Playbook', 'span': 2, 'description': 'A comprehensive report detailing findings, personas, and strategic recommendations.', 'imagePlaceholder': True}
        ],
        'processSteps': [
